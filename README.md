...
[![Site preview](/public/site-preview.png)](https://namankapasi.com)

My portfolio to showcase my work projects. Built with [Next.js](https://nextjs.org/), [Three.js](https://threejs.org/), and [Framer Motion](https://www.framer.com/motion/). View the [live site](https://namankapasi.com). This is a fork of the Hamish Williams Website.
